# Bab 43 — OOP: Class dan Object

**Tingkat:** Lanjutan  
**Tujuan:** Memahami class, instance, attribute, method, dan desain objek.

## 1. Penjelasan
Bab ini membahas oop: class dan object secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
OOP: Class dan Object adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti OOP: Class dan Object.
...
**Catatan khusus bab:** Class mendefinisikan perilaku dan data; object adalah instance dari class tersebut.
