# Bab 28 — requirements.txt

**Tingkat:** Menengah  
**Tujuan:** Mencatat dependency, memasang ulang environment, dan memahami version pinning.

## 1. Penjelasan
Bab ini membahas requirements.txt secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
requirements.txt adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti requirements.txt.
...
**Catatan khusus bab:** requirements.txt adalah format daftar dependency yang umum. Untuk proyek modern, pyproject.toml sering menjadi pusat konfigurasi packaging.
