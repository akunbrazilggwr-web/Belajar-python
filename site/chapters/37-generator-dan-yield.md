# Bab 37 — Generator dan yield

**Tingkat:** Menengah  
**Tujuan:** Membuat generator hemat memori dan memahami lazy evaluation.

## 1. Penjelasan
Bab ini membahas generator dan yield secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Generator dan yield adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Generator dan yield.
...
**Catatan khusus bab:** Generator menghasilkan nilai satu per satu sehingga cocok untuk stream atau dataset besar.
