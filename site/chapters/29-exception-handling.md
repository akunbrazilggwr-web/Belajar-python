# Bab 29 — Exception Handling

**Tingkat:** Menengah  
**Tujuan:** Menggunakan try/except/else/finally dan menangani error secara spesifik.

## 1. Penjelasan
Bab ini membahas exception handling secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Exception Handling adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Exception Handling.
...
**Catatan khusus bab:** Tangkap exception yang memang dapat ditangani. Jangan memakai except: secara luas karena dapat menyembunyikan bug.
