...
**Tingkat:** Lanjutan  
**Tujuan:** Memahami endpoint, method HTTP, status code, JSON API, dan desain client sederhana.

## 1. Penjelasan
Bab ini membahas rest api secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
REST API adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
**Catatan khusus bab:** REST memakai HTTP semantics; status code, method, resource, dan representasi response perlu konsisten.
