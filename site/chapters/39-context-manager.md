# Bab 39 — Context Manager

**Tingkat:** Menengah  
**Tujuan:** Menggunakan with dan membuat context manager untuk resource management.

## 1. Penjelasan
Bab ini membahas context manager secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Context Manager adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Context Manager.
...
**Catatan khusus bab:** Context manager menjamin pola setup/cleanup, misalnya file ditutup walaupun terjadi exception.
