# Bab 7 — Input dan Konversi Tipe

**Tingkat:** Pemula  
**Tujuan:** Menerima input pengguna dan mengubah string menjadi tipe data yang sesuai.

## 1. Penjelasan
input() selalu menghasilkan string. Jika membutuhkan angka, konversi secara eksplisit dan tangani input yang tidak valid.

## 2. Arti dan kegunaan
**Apa artinya?**  
Input dan Konversi Tipe adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
