# Bab 79 — Project Capstone Profesional

**Tingkat:** Pro  
**Tujuan:** Merancang aplikasi nyata dari requirement sampai testing, security review, dan deployment.

## 1. Penjelasan
Bab ini membahas project capstone profesional secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Project Capstone Profesional adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Project Capstone Profesional.
...
**Catatan khusus bab:** Capstone harus dimulai dari requirement dan threat model sederhana, bukan langsung menulis kode.
