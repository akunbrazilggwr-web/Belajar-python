# Bab 19 — Scope dan Namespace

**Tingkat:** Pemula  
**Tujuan:** Memahami local/global scope, aturan LEGB, dan cara menghindari variabel yang membingungkan.

## 1. Penjelasan
Python mengikuti aturan LEGB saat mencari nama: Local, Enclosing, Global, Built-in. Hindari global state yang tidak diperlukan.

## 2. Arti dan kegunaan
**Apa artinya?**  
Scope dan Namespace adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
