# Bab 31 — File dan Path

**Tingkat:** Menengah  
**Tujuan:** Membaca/menulis file dan bekerja lintas platform dengan pathlib.

## 1. Penjelasan
Bab ini membahas file dan path secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
File dan Path adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti File dan Path.
...
**Catatan khusus bab:** pathlib.Path lebih portabel daripada merangkai path dengan separator manual.
