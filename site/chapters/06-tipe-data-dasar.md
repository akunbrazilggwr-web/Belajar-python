# Bab 6 — Tipe Data Dasar

**Tingkat:** Pemula  
**Tujuan:** Mengenal int, float, str, bool, None dan cara memeriksa tipe dengan type().

## 1. Penjelasan
Tipe dasar yang sering digunakan adalah int, float, str, bool, dan NoneType. type(x) membantu memeriksa tipe saat belajar dan debugging.

## 2. Arti dan kegunaan
**Apa artinya?**  
Tipe Data Dasar adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
