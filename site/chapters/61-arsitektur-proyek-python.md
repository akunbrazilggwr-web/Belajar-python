# Bab 61 — Arsitektur Proyek Python

**Tingkat:** Pro  
**Tujuan:** Memilih struktur package, separation of concerns, dependency boundaries, dan maintainability.

## 1. Penjelasan
Bab ini membahas arsitektur proyek python secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Arsitektur Proyek Python adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Arsitektur Proyek Python.
...
**Catatan khusus bab:** Arsitektur yang baik membuat perubahan lokal tidak memaksa perubahan ke seluruh aplikasi.
