...
**Tingkat:** Pemula  
**Tujuan:** Membuat, membaca, mengubah, menghapus, dan mengiterasi list.

## 1. Penjelasan
List adalah collection yang mutable dan terurut. Gunakan append untuk satu item, extend untuk banyak item, dan pop untuk mengambil/menghapus item.

## 2. Arti dan kegunaan
**Apa artinya?**  
List adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
