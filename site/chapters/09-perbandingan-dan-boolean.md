# Bab 9 — Perbandingan dan Boolean

**Tingkat:** Pemula  
**Tujuan:** Menggunakan ==, !=, <, <=, >, >= serta logika True/False.

## 1. Penjelasan
Perbandingan menghasilkan bool. Operator and/or/not menggabungkan kondisi dan menggunakan short-circuit evaluation.

## 2. Arti dan kegunaan
**Apa artinya?**  
Perbandingan dan Boolean adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
