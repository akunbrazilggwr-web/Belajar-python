# Bab 25 — Modul dan import

**Tingkat:** Menengah  
**Tujuan:** Memecah program menjadi modul, menggunakan import, from-import, dan __name__.

## 1. Penjelasan
Bab ini membahas modul dan import secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Modul dan import adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Modul dan import.
...
**Catatan khusus bab:** Import dieksekusi saat modul pertama kali dimuat dalam proses. Hindari circular import dengan pembagian tanggung jawab yang jelas.
