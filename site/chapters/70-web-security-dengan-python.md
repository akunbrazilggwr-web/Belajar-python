# Bab 70 — Web Security dengan Python

**Tingkat:** Pro  
**Tujuan:** Memahami request validation, authentication, authorization, CSRF, SSRF, dan output encoding.

## 1. Penjelasan
Bab ini membahas web security dengan python secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Web Security dengan Python adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Web Security dengan Python.
...
**Catatan khusus bab:** Authentication menjawab siapa pengguna; authorization menentukan apa yang boleh dilakukan. Keduanya harus diperiksa di server.
