# Bab 64 — Dependency Injection

**Tingkat:** Pro  
**Tujuan:** Memisahkan dependency dari logika inti agar aplikasi mudah diuji dan dikembangkan.

## 1. Penjelasan
Bab ini membahas dependency injection secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Dependency Injection adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Dependency Injection.
...
**Catatan khusus bab:** Dependency injection membuat dependency eksplisit dan memudahkan pengujian tanpa resource nyata.
