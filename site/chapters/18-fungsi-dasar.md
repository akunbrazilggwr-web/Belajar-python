...
**Tingkat:** Pemula  
**Tujuan:** Membuat fungsi, parameter, return, default argument, dan dokumentasi fungsi.

## 1. Penjelasan
Fungsi mengelompokkan logika yang dapat dipanggil ulang. return mengembalikan hasil dan segera mengakhiri eksekusi fungsi.

## 2. Arti dan kegunaan
**Apa artinya?**  
Fungsi Dasar adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
