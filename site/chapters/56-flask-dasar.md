...
**Tingkat:** Lanjutan  
**Tujuan:** Memahami aplikasi Flask, routing, request, response, dan template secara terstruktur.

## 1. Penjelasan
Bab ini membahas flask dasar secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Flask Dasar adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Flask Dasar.
...
**Catatan khusus bab:** Flask ringan dan fleksibel. Saat aplikasi tumbuh, struktur blueprint/service/repository dapat membantu pemisahan tanggung jawab.
