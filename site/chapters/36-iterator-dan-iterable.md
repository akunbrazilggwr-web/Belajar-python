# Bab 36 — Iterator dan Iterable

**Tingkat:** Menengah  
**Tujuan:** Memahami iter(), next(), iterable protocol, dan perbedaan iterator dengan collection.

## 1. Penjelasan
Bab ini membahas iterator dan iterable secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Iterator dan Iterable adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Iterator dan Iterable.
...
**Catatan khusus bab:** Iterable dapat menghasilkan iterator. Iterator menyimpan state iterasi dan biasanya dikonsumsi satu kali.
