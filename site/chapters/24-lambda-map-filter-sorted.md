# Bab 24 — Lambda, map, filter, sorted

**Tingkat:** Menengah  
**Tujuan:** Memahami fungsi anonim dan operasi koleksi; memilih pendekatan yang tetap mudah dibaca.

## 1. Penjelasan
Bab ini membahas lambda, map, filter, sorted secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Lambda, map, filter, sorted adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Lambda, map, filter, sorted.
...
**Catatan khusus bab:** map/filter valid untuk transformasi sederhana, tetapi comprehension sering lebih idiomatis untuk Python modern.
