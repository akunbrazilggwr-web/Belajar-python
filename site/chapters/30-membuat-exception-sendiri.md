# Bab 30 — Membuat Exception Sendiri

**Tingkat:** Menengah  
**Tujuan:** Membuat exception custom dan merancang error yang informatif.

## 1. Penjelasan
Bab ini membahas membuat exception sendiri secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Membuat Exception Sendiri adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Membuat Exception Sendiri.
...
**Catatan khusus bab:** Exception custom sebaiknya menyampaikan kondisi domain yang memang perlu dibedakan oleh pemanggil.
