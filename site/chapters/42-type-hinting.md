...
**Tingkat:** Lanjutan  
**Tujuan:** Menggunakan anotasi tipe, Generic sederhana, Union/Optional, dan alat pemeriksa tipe.

## 1. Penjelasan
Bab ini membahas type hinting secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Type Hinting adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Type Hinting.
...
**Catatan khusus bab:** Type hints tidak mengubah runtime secara otomatis; alat seperti mypy/pyright dapat memeriksa konsistensi tipe.
