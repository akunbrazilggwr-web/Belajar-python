# Bab 15 — Tuple dan Unpacking

**Tingkat:** Pemula  
**Tujuan:** Memahami tuple, immutability, unpacking, dan kapan menggunakannya.

## 1. Penjelasan
Tuple terurut tetapi immutable. Tuple berguna untuk data yang tidak perlu diubah dan untuk multiple assignment/unpacking.

## 2. Arti dan kegunaan
**Apa artinya?**  
Tuple dan Unpacking adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
