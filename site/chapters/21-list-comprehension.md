# Bab 21 — List Comprehension

**Tingkat:** Menengah  
**Tujuan:** Menulis transformasi dan filtering data secara ringkas tanpa mengorbankan keterbacaan.

## 1. Penjelasan
Bab ini membahas list comprehension secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
List Comprehension adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti List Comprehension.
...
**Catatan khusus bab:** Comprehension sebaiknya digunakan ketika ekspresinya masih mudah dibaca; jika terlalu panjang, gunakan loop biasa.
