# Bab 32 — JSON dan Data Terstruktur

**Tingkat:** Menengah  
**Tujuan:** Serialisasi dan deserialisasi JSON serta validasi struktur data sederhana.

## 1. Penjelasan
Bab ini membahas json dan data terstruktur secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
JSON dan Data Terstruktur adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti JSON dan Data Terstruktur.
...
**Catatan khusus bab:** JSON hanya mendukung tipe data tertentu. Objek Python kompleks perlu diubah menjadi representasi yang serializable.
