# Bab 27 — pip dan Virtual Environment

**Tingkat:** Menengah  
**Tujuan:** Mengisolasi dependency proyek dengan venv dan memasang paket secara aman.

## 1. Penjelasan
Bab ini membahas pip dan virtual environment secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
pip dan Virtual Environment adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti pip dan Virtual Environment.
...
**Catatan khusus bab:** Virtual environment mencegah dependency satu proyek bercampur dengan proyek lain. Aktifkan environment sebelum memasang dependency.
