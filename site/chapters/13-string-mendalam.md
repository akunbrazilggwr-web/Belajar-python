# Bab 13 — String Mendalam

**Tingkat:** Pemula  
**Tujuan:** Indexing, slicing, method string, f-string, dan pemrosesan teks.

## 1. Penjelasan
String immutable. Index negatif dimulai dari akhir, sedangkan slicing memakai bentuk start:stop:step dengan batas stop tidak ikut.

## 2. Arti dan kegunaan
**Apa artinya?**  
String Mendalam adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
