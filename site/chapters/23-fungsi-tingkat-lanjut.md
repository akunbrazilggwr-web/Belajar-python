# Bab 23 — Fungsi Tingkat Lanjut

**Tingkat:** Menengah  
**Tujuan:** Mengenal *args, **kwargs, keyword-only arguments, dan unpacking.

## 1. Penjelasan
Bab ini membahas fungsi tingkat lanjut secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Fungsi Tingkat Lanjut adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Fungsi Tingkat Lanjut.
...
**Catatan khusus bab:** *args mengumpulkan positional arguments dan **kwargs mengumpulkan keyword arguments. Jangan memakai keduanya hanya demi terlihat canggih.
