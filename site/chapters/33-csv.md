...
**Tingkat:** Menengah  
**Tujuan:** Membaca dan menulis CSV menggunakan csv module dan memahami header/delimiter.

## 1. Penjelasan
Bab ini membahas csv secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
CSV adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
**Catatan khusus bab:** Gunakan csv module untuk data tabular sederhana dan perhatikan newline serta encoding ketika membuka file.
