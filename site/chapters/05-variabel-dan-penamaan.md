# Bab 5 — Variabel dan Penamaan

**Tingkat:** Pemula  
**Tujuan:** Memahami variabel, assignment, aturan penamaan, dan kebiasaan penamaan yang baik.

## 1. Penjelasan
Assignment mengikat sebuah nama ke objek. Python tidak mengharuskan deklarasi tipe variabel di awal, tetapi nilai tetap memiliki tipe.

## 2. Arti dan kegunaan
**Apa artinya?**  
Variabel dan Penamaan adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
