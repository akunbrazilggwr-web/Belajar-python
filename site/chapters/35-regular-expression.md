# Bab 35 — Regular Expression

**Tingkat:** Menengah  
**Tujuan:** Mencari dan mengekstrak pola teks menggunakan modul re secara tepat.

## 1. Penjelasan
Bab ini membahas regular expression secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Regular Expression adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Regular Expression.
...
**Catatan khusus bab:** Regex sangat kuat, tetapi jangan gunakan regex untuk masalah yang lebih tepat diselesaikan parser khusus.
