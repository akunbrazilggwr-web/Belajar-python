# Bab 3 — Menjalankan Program Python

**Tingkat:** Pemula  
**Tujuan:** Mengenal REPL, file .py, cara menjalankan program, dan struktur program sederhana.

## 1. Penjelasan
Ada dua cara umum belajar: REPL untuk eksperimen singkat dan file .py untuk program yang dapat disimpan. Menjalankan file membuat latihan mudah diulang.

## 2. Arti dan kegunaan
**Apa artinya?**  
Menjalankan Program Python adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Buat hello.py.
Isi dengan print('Halo, Python!').
Jalankan dengan python hello.py.
```
