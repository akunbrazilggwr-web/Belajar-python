# Bab 4 — print() dan Komentar

**Tingkat:** Pemula  
**Tujuan:** Menampilkan keluaran serta menulis komentar yang membantu pembaca memahami kode.

## 1. Penjelasan
print() menulis nilai ke output standar. Komentar diawali # dan tidak dieksekusi sebagai instruksi Python.

## 2. Arti dan kegunaan
**Apa artinya?**  
print() dan Komentar adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
print('Halo')
print('A', 'B', sep='-')
# komentar untuk menjelaskan alasan kode
```
