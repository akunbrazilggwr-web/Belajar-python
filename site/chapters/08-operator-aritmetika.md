# Bab 8 — Operator Aritmetika

**Tingkat:** Pemula  
**Tujuan:** Menggunakan +, -, *, /, //, %, dan ** serta memahami hasil masing-masing.

## 1. Penjelasan
Operator aritmetika mengikuti aturan prioritas matematika. / menghasilkan float, sedangkan // adalah floor division.

## 2. Arti dan kegunaan
**Apa artinya?**  
Operator Aritmetika adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
