# Bab 20 — Latihan Proyek Dasar

**Tingkat:** Pemula  
**Tujuan:** Menggabungkan konsep dasar dalam proyek CLI sederhana yang terstruktur.

## 1. Penjelasan
Proyek dasar sebaiknya memiliki input, validasi, fungsi, dan output yang jelas. Contoh aman untuk latihan adalah pengelola daftar tugas lokal.

## 2. Arti dan kegunaan
**Apa artinya?**  
Latihan Proyek Dasar adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Buat fungsi tambah_tugas().
Simpan daftar dalam list.
Sediakan menu loop.
Uji input kosong dan pilihan tidak dikenal.
```
