...
**Tingkat:** Pemula  
**Tujuan:** Membuat percabangan untuk menjalankan kode berdasarkan kondisi.

## 1. Penjelasan
Percabangan mengevaluasi kondisi dari atas ke bawah. Hanya blok yang kondisi pertamanya terpenuhi yang dijalankan.

## 2. Arti dan kegunaan
**Apa artinya?**  
if, elif, else adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
