...
**Tingkat:** Lanjutan  
**Tujuan:** Memahami event loop, coroutine, await, task, dan kapan async cocok digunakan.

## 1. Penjelasan
Bab ini membahas asyncio secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Asyncio adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
**Catatan khusus bab:** asyncio cocok untuk pekerjaan I/O yang dapat menunggu tanpa memblokir event loop. CPU-heavy work membutuhkan pendekatan berbeda.
