# Bab 22 — Dictionary/Set Comprehension

**Tingkat:** Menengah  
**Tujuan:** Membuat dictionary dan set secara deklaratif dengan kondisi dan ekspresi.

## 1. Penjelasan
Bab ini membahas dictionary/set comprehension secara bertahap. Fokus utamanya adalah memahami konsep, alasan penggunaannya, batasannya, lalu menerapkannya dalam program Python yang dapat diuji.

## 2. Arti dan kegunaan
**Apa artinya?**  
Dictionary/Set Comprehension adalah bagian dari ekosistem Python yang membantu programmer menyelesaikan masalah tertentu dengan cara yang terstruktur.
...
```python
Pahami konsep inti Dictionary/Set Comprehension.
...
**Catatan khusus bab:** Comprehension dapat memiliki kondisi, tetapi nested comprehension yang rumit sering lebih sulit dirawat.
